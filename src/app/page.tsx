...
const topics = [
  ...
  {
    id: 21, zh: '看医生', uz: 'Shifokorga borish', en: 'Going to Doctor',
    emoji: '🏥', color: 'from-rose-500 to-red-700',
    glow: 'rgba(244,63,94,0.6)', hsk: 2, words: 12,
    example: '我有点儿不舒服 (Yaxshi his qilmayapman)', desc: 'Salomatlik va shifoxona',
    image: 'https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=1200&q=80',
  },
  {
    id: 22, zh: '业余爱好', uz: "Bo'sh vaqt va hobbilar", en: 'Hobbies',
    emoji: '🎨', color: 'from-fuchsia-500 to-pink-700',
    glow: 'rgba(217,70,239,0.6)', hsk: 2, words: 12,
    example: '我喜欢画画 (Rasm chizishni yaxshi ko\'raman)', desc: 'Hobbi va qiziqishlar',
    image: 'https://images.unsplash.com/photo-1513475382585-d06e58bcb0e0?w=1200&q=80',
  },
  {
    id: 23, zh: '我的房子', uz: 'Mening uyim', en: 'My House',
    emoji: '🏠', color: 'from-amber-600 to-yellow-800',
    glow: 'rgba(217,119,6,0.6)', hsk: 2, words: 12,
    example: '我家有四个房间 (Uyimda 4 ta xona)', desc: 'Uy va xonalar',
    image: 'https://images.unsplash.com/photo-1568605114967-8130f3a36994?w=1200&q=80',
  },
  {
    id: 24, zh: '问路', uz: "Yo'l so'rash", en: 'Asking Directions',
    emoji: '🗺️', color: 'from-cyan-500 to-blue-700',
    glow: 'rgba(6,182,212,0.6)', hsk: 2, words: 12,
    example: '怎么走？(Qanday borish kerak?)', desc: "Yo'nalish va manzil",
    image: 'https://images.unsplash.com/photo-1569959220744-ff553533f492?w=1200&q=80',
  },
  {
    id: 25, zh: '在饭馆', uz: 'Restoranda', en: 'At Restaurant',
    emoji: '🍜', color: 'from-orange-500 to-red-700',
    glow: 'rgba(249,115,22,0.6)', hsk: 2, words: 12,
    example: '来一份饺子 (Bir porsiya manti)', desc: 'Ovqat buyurtmasi va menyu',
    image: 'https://images.unsplash.com/photo-1552566626-52f8b828add9?w=1200&q=80',
  },
  {
    id: 26, zh: '打电话', uz: 'Telefon qilish', en: 'Phone Calls',
    emoji: '📞', color: 'from-emerald-500 to-teal-700',
    glow: 'rgba(16,185,129,0.6)', hsk: 2, words: 12,
    example: '喂，你好 (Alyo, salom)', desc: "Qo'ng'iroq va xabar yozish",
    image: 'https://images.unsplash.com/photo-1556656793-08538906a9f8?w=1200&q=80',
  },
  {
    id: 27, zh: '学习汉语', uz: "Xitoy tilini o'rganish", en: 'Learning Chinese',
    emoji: '📖', color: 'from-indigo-500 to-purple-700',
    glow: 'rgba(99,102,241,0.6)', hsk: 2, words: 12,
    example: '我的汉语越来越好 (Tilim yaxshilanyapti)', desc: 'Til, dars va imtihon',
    image: 'https://images.unsplash.com/photo-1456513080510-7bf3a84b82f8?w=1200&q=80',
  },
  {
    id: 28, zh: '买衣服', uz: 'Kiyim-kechak xaridi', en: 'Buying Clothes',
    emoji: '👕', color: 'from-pink-500 to-rose-700',
    glow: 'rgba(236,72,153,0.6)', hsk: 2, words: 12,
    example: '这件多少钱？(Bu qancha?)', desc: 'Kiyim, ranglar va o\'lchov',
    image: 'https://images.unsplash.com/photo-1441984904996-e0b6ba687e04?w=1200&q=80',
  },
  {
    id: 29, zh: '运动', uz: 'Sport mashqlari', en: 'Sports',
    emoji: '⚽', color: 'from-lime-500 to-green-700',
    glow: 'rgba(132,204,22,0.6)', hsk: 2, words: 12,
    example: '我喜欢踢足球 (Futbol o\'ynashni yoqtiraman)', desc: 'Sport turlari va musobaqa',
    image: 'https://images.unsplash.com/photo-1517649763962-0c623066013b?w=1200&q=80',
  },
  {
    id: 30, zh: '节日', uz: 'Bayramlar', en: 'Festivals',
    emoji: '🎉', color: 'from-red-500 to-pink-700',
    glow: 'rgba(239,68,68,0.6)', hsk: 2, words: 12,
    example: '新年快乐！(Yangi yil muborak!)', desc: 'Bayramlar va an\'analar',
